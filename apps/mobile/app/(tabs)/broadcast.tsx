...
export default function BroadcastScreen() {
  ...
  // Keep the screen and CPU active while transmitting
  useKeepAwake();
  ...
  return (
    <View style={styles.container}>
      {/* Always-visible consent banner — physical indicator when mic is active */}
      {isLive && (
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardSubtitle}>
          Place this device near the sound source (TV, speaker). It will capture and stream ambient audio to your listening device.
        </Text>
        ...
        <View style={styles.toggleRow}>
          ...
          <Switch
            value={isLive || status === 'connecting'}
            onValueChange={handleToggle}
            trackColor={{ false: '#2e2e2e', true: '#1d4ed8' }}
            thumbColor={isLive ? '#3b82f6' : '#555'}
          />
        </View>
      </View>
